...
| Secret | Purpose |
| --- | --- |
| `OPENROUTER_API_KEY` | newsletter, YouTube, and the podcast transcript fallback (via podcastfy/LiteLLM), using free `:free` models. A one-time $10 OpenRouter top-up raises the free cap to 1,000 req/day (20 RPM). Required. |
